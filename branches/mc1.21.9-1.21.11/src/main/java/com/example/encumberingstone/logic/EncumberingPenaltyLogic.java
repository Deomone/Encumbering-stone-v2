...
public final class EncumberingPenaltyLogic {
	...
	public static void tick(ServerPlayerEntity player) {
		...
		applyModifier(player, EntityAttributes.MOVEMENT_SPEED, SPEED_MODIFIER_ID, value);
		applyModifier(player, EntityAttributes.JUMP_STRENGTH, JUMP_MODIFIER_ID, value);
	}
